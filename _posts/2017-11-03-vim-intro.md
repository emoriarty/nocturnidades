...
La pregunta que te puedes estar haciendo es ¿por qué usar _vim_ si voy a tener que aprender desde cero para manejarlo? Pues bien, reconozco que al principio cuesta adaptarse a un editor como _vim_ donde nada está donde uno espera. Es más, no hay nada que esté donde uno espera. Para que te hagas una idea de cuán distinto es puedes mirar la imagen a continuación. Observa que interfaz tan minimalista.

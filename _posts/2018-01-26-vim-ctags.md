...
Pero todavía no funciona bien con React. Así que en otra búsqueda di con otros dos artículos ([este][post1] y [este][post2]) que ampliaban los patrones de ctags. El resultado de mí ctags es el siguiente.

{% gist 7aec99ee11c7f1951e43918c0a94e20b %}

No se descartan cambios en el futuro.

Y esto es todo. A parte de estos consejos también recomiendo la lectura de el [capítulo 29][29] y [Tags and special searches][tags-special] del manual de vim para ampliar información al respecto.
